        ...
        <div className='min-h-screen w-full bg-gradient-to-br from-white via-blue-200/50 to-white'>
            ...
            <div className="relative z-10">
              ...
              isOpen ? "rotate-180" : ""
                ...
                className="absolute left-1/2 top-full mt-6 -translate-x-1/2 w-auto flex justify-center space-x-4 p-2 bg-white shadow-lg rounded-full bg-opacity-30 overflow-hidden"
                >
                {["Text", "Image"].map((item) => (
                    <button
                    key={item}
            ...
            <div className="flex flex-col  mt-5 max-w-prose h-[85vh] rounded-xl mx-auto justify-center">
                ...
                <div className="flex items-center justify-center w-full">
                    ...
                    <div className='relative flex flex-grow'>
                        ...
                        <textarea
                            type="text"
                            className={`flex-grow px-3 py-2 rounded-full resize-none break-words whitespace-pre-wrap
                            transition-all duration-300 ${
                                loading ? 'wave-bg' : 'bg-white'
                              }`}
